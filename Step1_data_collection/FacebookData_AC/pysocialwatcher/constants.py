# -*- coding: utf-8 -*-
import time
REACHESTIMATE_URL = "https://graph.facebook.com/v9.0/act_{}/delivery_estimate"
GRAPH_SEARCH_URL = "https://graph.facebook.com/v9.0/search"
TARGETING_SEARCH_URL = "https://graph.facebook.com/v9.0/act_{}/targetingsearch"
SAVE_EMPTY = True
SLEEP_TIME = 8
SAVE_EVERY = 300
MAX_NUMBER_TRY = 10
...
ALLOWED_FIELDS_IN_INPUT = DATAFRAME_COLUMNS + [PERFORM_AND_BETWEEN_GROUPS_INPUT_FIELD] + [API_PUBLISHER_PLATFORMS_FIELD] + ["work_positions"]
